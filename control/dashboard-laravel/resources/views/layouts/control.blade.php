...
@php
    $nav = [
        ...
        ['workers','Workers / Agents','dashboard.workers'], ['agent-theater','Agent Theater','dashboard.agent-theater'], ['orchestrator-console','Orchestrator Console','dashboard.orchestrator-console'], ['technical','Technical Analysis','dashboard.technical'], ['fundamental','Fundamental Analysis','dashboard.fundamental'],
